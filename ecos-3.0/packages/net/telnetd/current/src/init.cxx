...
#ifdef CYGNUM_TELNETD_SERVER_AUTO_START
...
class Cyg_Telnetd_Init_Class
{
public:
    Cyg_Telnetd_Init_Class();
};
 ...
 */
static Cyg_Telnetd_Init_Class telnetd_initializer CYGBLD_ATTRIB_INIT_PRI(CYG_INIT_IO_FS);

/* ----------------------------------------------------------------- */
/* Constructor, just calls the startup routine.
 */

Cyg_Telnetd_Init_Class::Cyg_Telnetd_Init_Class()
{
    cyg_telnetd_startup();
}

#endif // CYGNUM_TELNETD_SERVER_AUTO_START
