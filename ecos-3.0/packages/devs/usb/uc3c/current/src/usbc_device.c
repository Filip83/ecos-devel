...
{
    cyg_uint32        nb_trans;
    cyg_bool          shortpacket;
    cyg_bool          use_out_cache_buffer;
    cyg_bool          call_dsr;
    usbs_rx_endpoint  *endpoint;
}ep_job;

static cyg_uint32 udd_ctrl_prev_payload_nb_trans;
static cyg_uint32 udd_ctrl_payload_nb_trans;

//Endpoints control banks
UDC_BSS(32)
static volatile usb_desc_table_t udd_g_ep_table[2 * (UC3C_USB_ENDPOINTS + 1)];
...
static void usbs_uc3c_endpoint_start(usbs_rx_endpoint * pep);
static void usbs_uc3c_endpoint_set_halted(usbs_rx_endpoint * pep,
                                          cyg_bool new_value);


void usbs_uc3c_endpoint_abort(usbs_rx_endpoint * pep);

// Endpoint 0, the control endpoint, structure.
usbs_control_endpoint usbs_uc3c_ep0 = {
  ...
  start_fn:               usbs_uc3c_ep0_start,
  poll_fn:                usbs_uc3c_poll,
  interrupt_vector:       CYGNUM_HAL_VECTOR_USB,
...
usbs_rx_endpoint usbs_uc3c_ep1 = {
  start_rx_fn:    usbs_uc3c_endpoint_start,
  set_halted_fn:  usbs_uc3c_endpoint_set_halted,
...
usbs_rx_endpoint usbs_uc3c_ep2 = {
  start_rx_fn:    usbs_uc3c_endpoint_start,
  set_halted_fn:  usbs_uc3c_endpoint_set_halted,
  complete_fn:    (void (*)(void *, int)) 0,
  complete_data:  (void *) 0,
...
usbs_rx_endpoint usbs_uc3c_ep3 = {
  start_rx_fn:    usbs_uc3c_endpoint_start,
  set_halted_fn:  usbs_uc3c_endpoint_set_halted,
  complete_fn:    (void (*)(void *, int)) 0,
  complete_data:  (void *) 0,
...
usbs_rx_endpoint usbs_uc3c_ep4 = {
  start_rx_fn:    usbs_uc3c_endpoint_start,
  set_halted_fn:  usbs_uc3c_endpoint_set_halted,
  complete_fn:    (void (*)(void *, int)) 0,
  complete_data:  (void *) 0,
...
#if (UC3C_USB_ENDPOINTS > 5)
// Endpoint 5 Receive control structure
usbs_rx_endpoint usbs_uc3c_ep5 = {
  start_rx_fn:    usbs_uc3c_endpoint_start,
  set_halted_fn:  usbs_uc3c_endpoint_set_halted,
  complete_fn:    (void (*)(void *, int)) 0,
  complete_data:  (void *) 0,
...
usbs_rx_endpoint usbs_uc3c_ep6 = {
  start_rx_fn:    usbs_uc3c_endpoint_start,
  set_halted_fn:  usbs_uc3c_endpoint_set_halted,
  complete_fn:    (void (*)(void *, int)) 0,
  complete_data:  (void *) 0,
...
#if (UC3C_USB_ENDPOINTS > 7)
// Endpoint 7 Receive control structure
usbs_rx_endpoint usbs_uc3c_ep7 = {
  start_rx_fn:    usbs_uc3c_endpoint_start,
  set_halted_fn:  usbs_uc3c_endpoint_set_halted,
  complete_fn:    (void (*)(void *, int)) 0,
  complete_data:  (void *) 0,
...
// end point number
static const void *usbs_uc3c_endpoints[UC3C_USB_ENDPOINTS] = {
  (void *) &usbs_uc3c_ep0,
  (void *) &usbs_uc3c_ep1,
  (void *) &usbs_uc3c_ep2,
  (void *) &usbs_uc3c_ep3
#if (UC3C_USB_ENDPOINTS > 4)
  ,(void *) &usbs_uc3c_ep4, (void *) &usbs_uc3c_ep5
#if (UC3C_USB_ENDPOINTS > 6)
  ,(void *) &usbs_uc3c_ep6, (void *) &usbs_uc3c_ep7
#endif
#endif
};
//DSR type flag variable
static cyg_uint32 which_dsr = 0;
//DSR flags
#define DSR_USB_NONE			0
#define DSR_USB_DATA			1
#define DSR_USB_CONTROL			2
#define DSR_USB_RESET			4
#define DSR_USB_SUSPEND			8
#define DSR_USB_WAKE_UP			16
#define DSR_USB_VBUS			32
    
ep_job ep_job_str[UC3C_USB_ENDPOINTS] =
{
    {
        .nb_trans             = 0,
        .shortpacket          = true,
        .use_out_cache_buffer = false,
        .call_dsr             = false,
        .endpoint             = &usbs_uc3c_ep0
    },
    {
        .nb_trans             = 0,
        .shortpacket          = true,
...
static int
usbs_uc3c_pep_to_number(const usbs_rx_endpoint * pep)
{
    int epn;

    for(epn=0; epn < UC3C_USB_ENDPOINTS; epn++) {
        if (pep == usbs_uc3c_endpoints[epn])
            return epn;
    }
...
usbs_uc3c_control_data_recv(ep0_low_level_status_t status);

void usbs_uc3c_endpoint_init (const usb_endpoint_descriptor *ep);

static ep0_low_level_status_t
usbs_uc3c_control_data_sent(ep0_low_level_status_t status);

static cyg_bool
usbs_uc3c_endpoint_isr_rx(cyg_uint8 epn);
static cyg_bool
usbs_uc3c_endpoint_isr_tx(cyg_uint8 epn);

static ep0_low_level_status_t udd_ctrl_send_zlp_in(void);

static void
usbs_uc3c_reset_device (void);

static cyg_uint8 usb_address = 0;

/* Is the USB powered? */
cyg_bool
usbs_uc3c_read_power (void)
{
    return Is_otg_vbus_high();
}
...
usbs_end_all_transfers (usbs_control_return returncode)
{
    ...
    {
        if (Is_udd_endpoint_enabled(epn) && Is_udd_endpoint_interrupt_enabled(epn)) 
        {
	    cyg_uint32 irq;
	    ...
	    HAL_RESTORE_INTERRUPTS(irq);
            ...
            pep = (usbs_rx_endpoint *) usbs_uc3c_endpoints[epn];
...
void usbs_ep_alloc(void)
{
    ...
    usb_endpoints = usbs_uc3c_ep0.enumeration_data->endpoints;

    for (epn = 0;
    epn < usbs_uc3c_ep0.enumeration_data->total_number_endpoints;
    epn++) 
    {
        if ( epn < UC3C_USB_ENDPOINTS ) 
        {
            usbs_uc3c_endpoint_init(&usb_endpoints[epn]);
        }
    }
}
...
{
    udd_disable_address();
    udd_configure_address(usb_address);
    udd_enable_address();
...
static ep0_low_level_status_t udd_ctrl_send_zlp_in(void)
{
    ...
    HAL_RESTORE_INTERRUPTS(irq);
    return UDD_EPCTRL_HANDSHAKE_WAIT_IN_ZLP;
}	

static ep0_low_level_status_t udd_ctrl_send_zlp_out(void)
{
    cyg_uint32 irq;
    ...
    HAL_RESTORE_INTERRUPTS(irq);
	return UDD_EPCTRL_HANDSHAKE_WAIT_OUT_ZLP;
}

static ep0_low_level_status_t udd_ctrl_underflow(ep0_low_level_status_t status)
{
    if (Is_udd_out_received(0))
        return status; // underflow ignored if OUT data is received
    ...
    } else if (UDD_EPCTRL_HANDSHAKE_WAIT_OUT_ZLP == status) {
...
static  ep0_low_level_status_t udd_ctrl_overflow(ep0_low_level_status_t status)
{
    if (Is_udd_in_send(0)) {
        return status; // overflow ignored if IN data is received
    }
...
void
usbs_uc3c_endpoint_set_halted (usbs_rx_endpoint * pep, cyg_bool new_value)
{
  int epn = usbs_uc3c_pep_to_number(pep);
...
void
usbs_uc3c_endpoint_init (const usb_endpoint_descriptor *ep)
{
...
void
usbs_uc3c_handle_reset (void)
{
    usbs_uc3c_reset_device ();
}

void
usbs_uc3c_ep0_start (usbs_control_endpoint * endpoint)
{
    int irq;
...
void
usbs_uc3c_endpoint_start (usbs_rx_endpoint * pep)
{
    int epn = usbs_uc3c_pep_to_number(pep);
    int epsize;
    ...
    cyg_drv_dsr_lock ();
    if (usbs_uc3c_ep0.state != USBS_STATE_CONFIGURED) {
    ...
    {
        usbs_uc3c_endpoint_isr_tx(epn);
    }
    else
    {
        usbs_uc3c_endpoint_isr_rx(epn);
    }
...
// Handle a DSR for an endpoint
 void
usbs_uc3c_endpoint_dsr (cyg_uint8 epn)
{
    ep_job *ptr_job = &ep_job_str[epn];
    usbs_rx_endpoint *pep = (usbs_rx_endpoint *) usbs_uc3c_endpoints[epn];
...
cyg_bool
usbs_uc3c_endpoint_isr (cyg_uint8 epn)
{
    CYG_ASSERT (UC3C_USB_ENDPOINTS > epn && epn, "Invalid end point");
    ...
    if(Is_udd_endpoint_in(epn))
    {
        if(usbs_uc3c_endpoint_isr_tx(epn))
        {
            return true;
        }
    }
    ...
    {
        if(usbs_uc3c_endpoint_isr_rx(epn))
        {
            return true;
        }
    }
...
ep0_low_level_status_t
usbs_uc3c_control_error(ep0_low_level_status_t status)
{

    usbs_uc3c_ep0.buffer_size = 0;
    usbs_uc3c_ep0.fill_buffer_fn = 0;
    usbs_uc3c_ep0.complete_fn = 0;


    if (status == UDD_EPCTRL_SETUP ) {
        if (usbs_uc3c_ep0.complete_fn) {
        (*usbs_uc3c_ep0.complete_fn) (&usbs_uc3c_ep0,
...
// Handle a get status setup message on the control end point
 ep0_low_level_status_t
usbs_uc3c_control_setup_get_status(void)
{
  ep0_low_level_status_t status;
  usb_devreq *req = (usb_devreq *)usbs_uc3c_ep0.control_buffer;
  ...
  *((cyg_uint16*)usbs_uc3c_ep0.control_buffer) = word;
  usbs_uc3c_ep0.buffer_size = sizeof (word);
  return status;
}
...
ep0_low_level_status_t
usbs_uc3c_control_setup_set_feature(void)
{
  ep0_low_level_status_t status;
  usb_devreq *req = (usb_devreq *)usbs_uc3c_ep0.control_buffer;
  cyg_uint8 recipient = req->type & USB_DEVREQ_RECIPIENT_MASK;
  ...
  //usbs_uc3c_control_setup_send_ack();
  status = UDD_EPCTRL_SETUP;
  ...
  switch(recipient) {
    ...
    case USB_DEVREQ_RECIPIENT_ENDPOINT:
      ...
      /*  cyg_uint32 CSR;
        ...
        pep = (usbs_rx_endpoint *) usbs_uc3c_endpoints[epn];
        if ( !Is_udd_stall(epn) ) {
          usbs_uc3c_endpoint_set_halted ( pep , true );
        }
        else
          status = UDD_EPCTRL_STALL_REQ ;
...
// Handle a get status clear feature message on the control endpoint
 ep0_low_level_status_t
usbs_uc3c_control_setup_clear_feature(void)
{
  ep0_low_level_status_t status;
  usb_devreq *req = (usb_devreq *)usbs_uc3c_ep0.control_buffer;
  cyg_uint8 recipient = req->type & USB_DEVREQ_RECIPIENT_MASK;
    ...
    case USB_DEVREQ_RECIPIENT_ENDPOINT:
      if ((usbs_uc3c_ep0.state == USBS_STATE_CONFIGURED) &&
        ...
        if ( Is_udd_stall(epn) && pep->halted ) {
          usbs_uc3c_endpoint_set_halted ( pep , false );
        }
        else
          status = UDD_EPCTRL_STALL_REQ;
...
// Handle a setup message from the host
 ep0_low_level_status_t
usbs_uc3c_control_setup(ep0_low_level_status_t status)
{
  usb_devreq *req = (usb_devreq *) usbs_uc3c_ep0.control_buffer;
  cyg_uint8   protocol;
  cyg_uint16 length;
  ...
  if (protocol == USB_DEVREQ_TYPE_STANDARD) {
    ...
    switch (req->request) {
      case USB_DEVREQ_GET_STATUS:
        status = usbs_uc3c_control_setup_get_status();
        break;
      case USB_DEVREQ_SET_ADDRESS:
		CYG_TRACE0( true, "Control Setup Set Addr\n" );
		usb_address = req->value_lo;
		usbs_uc3c_ep0.complete_fn = &usb_set_address;
        break;
      case USB_DEVREQ_SET_FEATURE:
        status = usbs_uc3c_control_setup_set_feature();
        break;
      case USB_DEVREQ_CLEAR_FEATURE:
        status = usbs_uc3c_control_setup_clear_feature();
        break;
      default:
        handled = false;
    }
    ...
    if ((protocol != USB_DEVREQ_TYPE_STANDARD) || !handled) 
    {
      ...
      usbcode = usbs_parse_host_get_command (&usbs_uc3c_ep0);
      usbs_uc3c_ep0.buffer_size = MIN (usbs_uc3c_ep0.buffer_size, length);
          if (usbcode == USBS_CONTROL_RETURN_HANDLED)
          {
              handled = true;
              if(usbs_uc3c_ep0.fill_buffer_fn)
              {
                  cyg_uint32 pos = 0;
                  memcpy(buf,usbs_uc3c_ep0.buffer,usbs_uc3c_ep0.buffer_size);
                  pos += usbs_uc3c_ep0.buffer_size;
                  while(usbs_uc3c_ep0.fill_buffer_fn)
                  {
                      if((usbs_uc3c_ep0.buffer_size + pos) < 100)
                      {
                          (*usbs_uc3c_ep0.fill_buffer_fn) (&usbs_uc3c_ep0);
                          memcpy(buf + pos,usbs_uc3c_ep0.buffer,usbs_uc3c_ep0.buffer_size);
                          pos += usbs_uc3c_ep0.buffer_size;
                      }
                      else
                      {
                  ...
                  usbs_uc3c_ep0.buffer = buf;
                  usbs_uc3c_ep0.buffer_size = pos;
              }			
...
usbs_uc3c_control_data_recv(ep0_low_level_status_t status)
{
    ...
    memcpy((cyg_uint8 *) (usbs_uc3c_ep0.buffer + usbs_uc3c_ep0.buffer_size),
                    udd_ctrl_buffer, nb_data);
    usbs_uc3c_ep0.buffer_size  += nb_data;
    ...
    if(nb_data < USB_DEVICE_EP_CTRL_SIZE)
    {
        ...
        if (usbs_uc3c_ep0.complete_fn)
        {
            usbcode = (*usbs_uc3c_ep0.complete_fn) (&usbs_uc3c_ep0, 0);
        }
...
usbs_uc3c_control_data_sent(ep0_low_level_status_t status)
{
	...
	/////
    nb_remain = usbs_uc3c_ep0.buffer_size - udd_ctrl_payload_nb_trans;
    if (0 == nb_remain) 
    {
        ...
        if ((usbs_uc3c_ep0.buffer_size == udd_ctrl_prev_payload_nb_trans)
                        || b_shortpacket) 
        {
    ...
    memcpy(udd_ctrl_buffer,
            usbs_uc3c_ep0.buffer + udd_ctrl_payload_nb_trans,
            nb_remain);
...
//
 ...
 void
usbs_uc3c_dsr (cyg_vector_t vector, cyg_ucount32 count, cyg_addrword_t data)
{
    int n;
    ...
    while(which_dsr)
    {
        ...
        if (which_dsr&DSR_USB_RESET)
        {
            ...
            usbs_uc3c_handle_reset ();
            //otg_freeze_clock();
            usbs_uc3c_ep0.state = USBS_STATE_DEFAULT;
            usbs_state_notify (&usbs_uc3c_ep0);
        ...
        {
            usbs_uc3c_ep0.state = usbs_uc3c_ep0.state | USBS_STATE_SUSPENDED;
            usbs_state_notify (&usbs_uc3c_ep0);
            //otg_unfreeze_clock();
...
cyg_uint32
usbs_uc3c_isr (cyg_vector_t vector, cyg_addrword_t data)
{
...
void
usbs_uc3c_poll (usbs_control_endpoint * endpoint)
{
  CYG_ASSERT (endpoint == &usbs_uc3c_ep0, "Wrong endpoint");
  if (CYG_ISR_CALL_DSR == usbs_uc3c_isr (CYGNUM_HAL_VECTOR_USB, 0)) {
    usbs_uc3c_dsr (CYGNUM_HAL_VECTOR_USB, 0, 0);
  }
}
