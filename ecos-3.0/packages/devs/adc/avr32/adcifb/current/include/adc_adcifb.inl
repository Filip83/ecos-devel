...
#ifndef CYGONCE_DEVS_ADC_AVR32_ADCIFB_INL
#define CYGONCE_DEVS_ADC_AVR32_ADCIFB_INL

// Declare ADC0
#ifdef CYGPKG_DEVS_ADC_AVR32_ADCIFB_ADC0

static avr32_adc_info avr32_adc0_info =
{
    .adc_base         = AVR32_ADCIFB_ADDRESS,
    .adc_vector       = CYGNUM_HAL_VECTOR_ADCIFB,
    .adc_intprio      = CYGNUM_DEVS_ADC_AVR32_ADCIFB_ADC0_INTPRIO,
    .int_handle       = 0,
    .adc_prescal      = CYGNUM_DEVS_ADC_AVR32_ADCIFB_ADC0_PRESCAL,
    .adc_startup_time = CYGNUM_DEVS_ADC_AVR32_ADCIFB_ADC0_STARTUP_TIME,
    .adc_shtim        = CYGNUM_DEVS_ADC_AVR32_ADCIFB_ADC0_SHTIM,
#if CYGNUM_IO_ADC_SAMPLE_SIZE > 11
     .resolution      = 3,
#elif CYGNUM_IO_ADC_SAMPLE_SIZE > 10
     .resolution      = 2,
#elif CYGNUM_IO_ADC_SAMPLE_SIZE > 9
     .resolution      = 1,
#else
     .resolution      = 0,
#endif
...
CYG_ADC_DEVICE( avr32_adc0_device,
                &avr32_adc_funs,
                &avr32_adc0_info,
                CYGNUM_DEVS_ADC_AVR32_ADCIFB_ADC0_DEFAULT_RATE);

#define AVR32_ADC0_CHANNEL( __chan )                                        \
CYG_ADC_CHANNEL( avr32_adc0_channel##__chan,                                \
                 __chan,                                                    \
                 CYGDAT_DEVS_ADC_AVR32_ADCIFB_ADC0_CHANNEL##__chan##_BUFSIZE, \
                 &avr32_adc0_device );                                      \
                                                                            \
DEVTAB_ENTRY( avr32_adc0_channel##__chan##_device,                          \
              CYGDAT_DEVS_ADC_AVR32_ADCIFB_ADC0_CHANNEL##__chan##_NAME,       \
              0,                                                            \
              &cyg_io_adc_devio,                                            \
              avr32_adc_init,                                               \
              avr32_adc_lookup,                                             \
...
AVR32_ADC0_CHANNEL(8);
#endif

#endif // CYGPKG_DEVS_ADC_AVR32_ADCIFB

#endif // CYGONCE_DEVS_ADC_AVR32_ADCIFB_INL
