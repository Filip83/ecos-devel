#ifndef CYGONCE_DEVS_USART_SPI_AVR32_UC3C
#define CYGONCE_DEVS_USART_SPI_AVR32_UC3C
//==========================================================================
//
//      usart_spi_uc3c.h
//
...
//-----------------------------------------------------------------------------
// AVR32UC3C USART SPI BUS

typedef struct cyg_usart_spi_avr32_bus_s
{
    // ---- Upper layer data ----
    ...
    cyg_uint32        npcs_gpio_pin[4];     // npcs pin numbers
} cyg_usart_spi_avr32_bus_t;

//-----------------------------------------------------------------------------
// AVR32UC3C0512 USART SPI DEVICE

typedef struct cyg_usart_spi_avr32_device_s
{
    // ---- Upper layer data ----
...
} cyg_usart_spi_avr32_device_t;

//-----------------------------------------------------------------------------
// AVR32UC3C USART SPI exported busses

/* For backwards compatability  */
#if 0
#define cyg_usart_spi_avr32_bus   cyg_usart_spi_avr32_bus0
externC cyg_usart_spi_avr32_bus_t cyg_usart_spi_avr32_bus0;

#define cyg_usart_spi_avr32_bus   cyg_usart_spi_avr32_bus1
externC cyg_usart_spi_avr32_bus_t cyg_usart_spi_avr32_bus1;

#define cyg_usart_spi_avr32_bus   cyg_usart_spi_avr32_bus2
externC cyg_usart_spi_avr32_bus_t cyg_usart_spi_avr32_bus2;

#define cyg_usart_spi_avr32_bus   cyg_usart_spi_avr32_bus3
externC cyg_usart_spi_avr32_bus_t cyg_usart_spi_avr32_bus3;

#define cyg_usart_spi_avr32_bus   cyg_usart_spi_avr32_bus4
externC cyg_usart_spi_avr32_bus_t cyg_usart_spi_avr32_bus4;
#endif
//-----------------------------------------------------------------------------

#endif // CYGONCE_DEVS_USART_SPI_AVR32_UC3C_H

//-----------------------------------------------------------------------------
// End of usart_spi_avr32.h
