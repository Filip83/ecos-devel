#ifndef CYGONCE_DEVS_FLASH_SPI_N25QXX_H
#define CYGONCE_DEVS_FLASH_SPI_N25QXX_H
...
// Purpose:     Micron N25Qxxx SPI flash driver
//              implementation
//
//####DESCRIPTIONEND####
//
...
externC struct cyg_flash_dev_funs cyg_devs_flash_spi_n25qxx_funs;

//-----------------------------------------------------------------------------
// Macro used to generate a flash device object with the default N25QXX
...
#define CYG_DEVS_FLASH_SPI_N25QXX_DRIVER(_name_, _start_, _spidev_)    \
struct cyg_flash_block_info _name_ ##_block_info;                      \
CYG_FLASH_DRIVER(_name_, &cyg_devs_flash_spi_n25qxx_funs, 0,           \
    _start_, _start_, 1, & _name_ ##_block_info, (void*) _spidev_)

//=============================================================================

//-----------------------------------------------------------------------------
#endif // CYGONCE_DEVS_FLASH_SPI_N25QXX_H
// EOF n25qxx.h
