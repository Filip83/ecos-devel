#ifndef CYGONCE_DEVS_FLASH_SPI_MT25QL_H
#define CYGONCE_DEVS_FLASH_SPI_MT25QL_H
...
externC struct cyg_flash_dev_funs cyg_devs_flash_spi_mt25ql_funs;
...
#define CYG_DEVS_FLASH_SPI_MT25QL_DRIVER(_name_, _start_, _spidev_)    \
struct cyg_flash_block_info _name_ ##_block_info;                      \
CYG_FLASH_DRIVER(_name_, &cyg_devs_flash_spi_mt25ql_funs, 0,           \
    _start_, _start_, 1, & _name_ ##_block_info, (void*) _spidev_)

//=============================================================================

//-----------------------------------------------------------------------------
#endif // CYGONCE_DEVS_FLASH_SPI_MT25QL_H
// EOF mt25ql.h
