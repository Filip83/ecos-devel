#ifndef CYGONCE_DEVS_FLASH_SPI_FM25WXX_H
#define CYGONCE_DEVS_FLASH_SPI_FM25WXX_H
...
// Purpose:     Ramtorn FM25Vxxx SPI fram driver
//              implementation
//
//####DESCRIPTIONEND####
//
...
externC struct cyg_flash_dev_funs cyg_devs_flash_spi_fm25vxx_funs;
...
#define CYG_DEVS_FLASH_SPI_FM25VXX_DRIVER(_name_, _start_, _spidev_)    \
struct cyg_flash_block_info _name_ ##_block_info;                       \
CYG_FLASH_DRIVER(_name_, &cyg_devs_flash_spi_fm25vxx_funs, 0,           \
    _start_, _start_, 1, & _name_ ##_block_info, (void*) _spidev_)

//=============================================================================

//-----------------------------------------------------------------------------
#endif // CYGONCE_DEVS_FLASH_SPI_FM25WXX_H
// EOF fm25wxx.h
