...
#define CYGHWR_DEV_FREESCALE_UART_PFIFO_TXFE   (0x80)
#define CYGHWR_DEV_FREESCALE_UART_PFIFO_RXFE   (0x08)

#define CYGHWR_DEV_FREESCALE_UART_CFIFO_TXFLUSH (0x80)
#define CYGHWR_DEV_FREESCALE_UART_CFIFO_RXFLUSH (0x40)
#define CYGHWR_DEV_FREESCALE_UART_CFIFO_RXOFE   (0x04)
#define CYGHWR_DEV_FREESCALE_UART_CFIFO_TXOFE   (0x02)
#define CYGHWR_DEV_FREESCALE_UART_CFIFO_RXUFE   (0x01)
 
#define CYGHWR_DEV_FREESCALE_UART_MODEM_RXRTSE   (0x08)
#define CYGHWR_DEV_FREESCALE_UART_MODEM_TXRTSPOL (0x04)
#define CYGHWR_DEV_FREESCALE_UART_MODEM_TXRTSE   (0x02)
#define CYGHWR_DEV_FREESCALE_UART_MODEM_TXCTSE   (0x01)

#define CYGHWR_DEV_FREESCALE_UART_C5_TDMAS       (0x80)
#define CYGHWR_DEV_FREESCALE_UART_C5_RDMAS       (0x20)
