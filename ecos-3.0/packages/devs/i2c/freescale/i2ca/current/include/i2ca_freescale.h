...
#ifndef CYGONCE_I2CA_FREESCALE_H
#define CYGONCE_I2CA_FREESCALE_H

#include <pkgconf/devs_i2c_freescale_i2ca.h>
...
#define FREESCALE_I2C_F_IC_M  0x3Fu
#define FREESCALE_I2C_F_IC_S  0
#define FREESCALE_I2C_F_IC(x)                                          \
  (((cyg_uint8)(((cyg_uint8)(x))<<FREESCALE_I2C_F_IC_S)) &             \
   FREESCALE_I2C_F_IC_M)
#define FREESCALE_I2C_F(__ic) \
   FREESCALE_I2C_F_IC (__ic)

#define FREESCALE_I2C_I2CR_RSTA_M 0x4u
#define FREESCALE_I2C_I2CR_TXAK_M 0x8u
#define FREESCALE_I2C_I2CR_MTX_M  0x10u
#define FREESCALE_I2C_I2CR_MSTA_M 0x20u
#define FREESCALE_I2C_I2CR_IIEN_M 0x40u
#define FREESCALE_I2C_I2CR_IEN_M  0x80u

#define FREESCALE_I2C_I2SR_RXAK_M 0x1u
#define FREESCALE_I2C_I2SR_IIF_M  0x2u
#define FREESCALE_I2C_I2SR_SRW_M  0x4u
#define FREESCALE_I2C_I2SR_IAL_M  0x10u
#define FREESCALE_I2C_I2SR_IBB_M  0x20u
#define FREESCALE_I2C_I2SR_IAAS_M 0x40u
#define FREESCALE_I2C_I2SR_ICF_M  0x80u
...
#define FREESCALE_I2C_DELAY_IS_AGRESIVE(__delay) \
...
#endif // CYGONCE_I2CA_FREESCALE_H
// -------------------------------------------------------------------------
// EOF i2ca_freescale.h
