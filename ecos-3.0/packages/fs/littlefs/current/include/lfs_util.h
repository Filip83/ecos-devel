...
#define LFS_INFO(fmt, ...)  diag_printf("lfs info:%d: " fmt "\n", __LINE__, __VA_ARGS__)
#else
#define LFS_INFO(fmt, ...)
#endif
...
#define LFS_DEBUG(fmt, ...) diag_printf("lfs debug:%d: " fmt "\n", __LINE__, __VA_ARGS__)
#else
...
#define LFS_WARN(fmt, ...)  diag_printf("lfs warn:%d: " fmt "\n", __LINE__, __VA_ARGS__)
#else
#define LFS_WARN(fmt, ...)
#endif
...
#define LFS_ERROR(fmt, ...) diag_printf("lfs error:%d: " fmt "\n", __LINE__, __VA_ARGS__)
#else
