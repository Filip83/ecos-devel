...
protected:
     ...
     */
    //CYG_FAILED("Invalid copy construction of a NonCopyable resource.")
    NonCopyable(const NonCopyable &)
    {
    	CYG_FAIL("Invalid copy construction of a NonCopyable resource: \n");
    }
     ...
     * Copying of noncopyable resources can lead to resource leak and random error.
     */
    //CYG_FAILED("Invalid copy assignment of a NonCopyable resource.")
    NonCopyable &operator=(const NonCopyable &)
    {
    	CYG_FAIL("Invalid copy assignment of a NonCopyable resource: \n");
        return *this;
    }
