...
#include <pkgconf/nmea_lib.h>
#define NMEA_CONVSTR_BUF    (CYGNUM_NMEA_LIB_CONVSTR_BUF_SIZE)
#define NMEA_TIMEPARSE_BUF  (CYGNUM_NMEA_LIB_TIMEPARSE_BUF_SIZE)//(CYGPKG_NMEA_TIMEPARSE_BUF)
...
#   define NMEA_ASSERT(x)   CYG_ASSERT(x,"Nmea error\n")
#else
