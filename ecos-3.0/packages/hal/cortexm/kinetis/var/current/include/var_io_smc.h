 ...
 * Author: filip
 *
 * Created on 25. září 2017, 14:15
 */

#ifndef CYGONCE_HAL_VAR_IOSMC_H 
#define CYGONCE_HAL_VAR_IOSMC_H
...
typedef volatile struct {
  ...
  volatile cyg_uint8 PMSTAT;                             /**< Power Mode Status register, offset: 0x3 */
} SMC_Type;
