...
#define CYGHWR_IO_FREESCALE_SPI2_PIN_SIN  CYGHWR_HAL_KINETIS_PIN(D, 14, 2, KINETIS_PIN_SPI2_IN_OPT)
#define CYGHWR_IO_FREESCALE_SPI2_PIN_SOUT CYGHWR_HAL_KINETIS_PIN(D, 13, 2, KINETIS_PIN_SPI2_OUT_OPT)
#define CYGHWR_IO_FREESCALE_SPI2_PIN_SCK  CYGHWR_HAL_KINETIS_PIN(D, 12, 2, KINETIS_PIN_SPI2_SCK_OPT)

#define CYGHWR_IO_FREESCALE_SPI2_PIN_CS0  CYGHWR_HAL_KINETIS_PIN(D, 11, 2, KINETIS_PIN_SPI2_CS_OPT)
#define CYGHWR_IO_FREESCALE_SPI2_PIN_CS1  CYGHWR_HAL_KINETIS_PIN(D, 15, 2, KINETIS_PIN_SPI2_CS_OPT)
