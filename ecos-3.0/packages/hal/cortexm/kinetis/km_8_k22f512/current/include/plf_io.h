...
#define FREESCALE_DMAMUX_SRC_KINETIS_EHCI_TX FREESCALE_DMAMUX_SRC_KINETIS_UART1T
#define FREESCALE_DMAMUX_SRC_KINETIS_EHCI_RX FREESCALE_DMAMUX_SRC_KINETIS_UART1R
// DSPI
// DSPI0 Pins
