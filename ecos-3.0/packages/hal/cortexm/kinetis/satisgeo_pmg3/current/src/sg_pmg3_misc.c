//==========================================================================
//
//      frdm_k64f1024_misc.c
//
//      Cortex-M4 FRDM-K64 EVAL HAL functions
//
//==========================================================================
...
#include <cyg/io/i2c_freescale_buses.inl> // I2C busses definition
...
CYG_DEVS_SPI_FREESCALE_DSPI_DEVICE(
	...
	0,                                      // SPI bus
	CYGHWR_DEVS_FRAM_FM25VXX_DEV1_SPI_CS,   // Dev num (CS)
...
CYG_DEVS_SPI_FREESCALE_DSPI_DEVICE(
	...
	0,                                      // SPI bus
	CYGHWR_DEVS_FLASH_MT25QL_DEV2_SPI_CS,     // Dev num (CS)
	MT25QL_SPI_FRAME_SIZE,                  // Frame size
