...
#endif
#define CYGMEM_REGION_sram_l (0x1FFF0000)
#define CYGMEM_REGION_sram_l_SIZE (0x10000-CYGNUM_HAL_COMMON_INTERRUPTS_STACK_SIZE)
#define CYGMEM_REGION_sram_l_ATTR (CYGMEM_REGION_ATTR_R | CYGMEM_REGION_ATTR_W)

#define CYGMEM_REGION_sram_u (0x20000000)
#define CYGMEM_REGION_sram_u_SIZE (0x30000)
